...
Document templates control how your invoices, quotes, and other PDF documents look. Navigate to **Settings > Document Templates**.
...
The generated PDF follows a clean, Stripe-inspired design:
