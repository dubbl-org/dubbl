...
<Steps>
  <Step>
    ...
    Fork the repository on [GitHub](https://github.com/dubbl-org/dubbl), then clone your fork and create a new branch.
  </Step>
  <Step>
    ### Make your changes
...
<Cards>
  <Card title="Code" description="Fix bugs, implement features, improve performance" href="https://github.com/dubbl-org/dubbl/issues" />
  <Card title="Documentation" description="Fix typos, add guides, improve clarity" href="https://github.com/dubbl-org/dubbl" />
  <Card title="Tax & Compliance" description="Report outdated tax info, submit corrections" href="https://github.com/dubbl-org/dubbl/issues" />
</Cards>
