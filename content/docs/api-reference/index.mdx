---
title: API Reference
description: REST API documentation for dubbl.
---
...
### Session Cookie
Automatically included when making requests from the dubbl web app.
...
| POST | `/api/v1/bank-accounts/:id/transactions/import` | Import CSV |
