...
description: How debits, credits, and journal entries work in dubbl.
---
...
See [Journal Entries](/docs/modules/journal-entries) for details on creating and managing entries in dubbl.
