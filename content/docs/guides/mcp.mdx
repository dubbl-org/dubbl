...
3. The token exchange (step 4) should return `403` with `"MCP access requires a Pro or Business plan"`

### With Claude Desktop (local)

For local testing with Claude Desktop, update your config to point at localhost:
...
Restart Claude Desktop and it will initiate the OAuth flow in your browser.
