...
description: Architecture overview and conventions for contributing to dubbl.
---
...
The MCP server lets AI agents interact with dubbl via the [Model Context Protocol](https://modelcontextprotocol.io). See the [MCP guide](/docs/guides/mcp) for user-facing docs.
