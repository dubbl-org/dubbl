/**
 * Cron job script for processing scheduled reports.
 * Meant to run as a separate Railway cron service (e.g. every 15 minutes).
 *
 * Required env vars:
...
const url = `${APP_URL}/api/cron/report-schedules`;
