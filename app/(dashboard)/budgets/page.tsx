  ...
  if (!loading && budgets.length === 0) {
    return (
      <div className="space-y-6">
        <PageHeader title="Budgets" description="Plan and track your financial budgets." />
        <EmptyState icon={Target} title="No budgets yet" description="Create your first budget to start tracking spending against targets.">
          <Button onClick={() => router.push("/budgets/new")} className="bg-emerald-600 hover:bg-emerald-700">
