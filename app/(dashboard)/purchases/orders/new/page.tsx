...
export default function NewPurchaseOrderPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/v1/purchase-orders", {
        ...
        body: JSON.stringify({
          contactId, issueDate, deliveryDate: deliveryDate || null, reference: reference || null, notes: notes || null,
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="New Purchase Order" description="Create a purchase order." />
      <form onSubmit={handleSubmit} className="max-w-4xl space-y-6">
        ...
        <div className="flex justify-end gap-3">
          <Button type="button" variant="outline" asChild><Link href="/purchases/orders">Cancel</Link></Button>
