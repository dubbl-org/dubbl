      ...
      {loading ? (
        <div className="space-y-6">
          ...
          <div className="space-y-0">
            {[1, 2, 3, 4, 5].map((i) => <Skeleton key={i} className="h-12 rounded-none first:rounded-t-lg last:rounded-b-lg" />)}
          </div>
        </div>
      ) : lines.length === 0 ? (
        <EmptyState
          ...
          description="No income or expenses found for the selected tax year. Once you have invoices and bills, this worksheet will map them to IRS Schedule C line items."
        >
